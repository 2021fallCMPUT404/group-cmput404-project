...
class Post(models.Model):
    ...
    '''
    def create_post( title, text, image, pub_date, author, shared_user, shared_on, privacy, contentType):
        Post.objects.get_or_create(title, text, image, pub_date, author, shared_user, shared_on, privacy, contentType)
    '''
