...
urlpatterns = [
    ...
    path('get_posts_from_user/<str:username>',
         views.get_posts_from_user,
         name='get_posts_from_user'),
    ...
    path('get_comments_from_post/<int:post_id>',
         views.get_comments_from_post,
         name='get_comments_from_post'),
    path('manage_post_comment/<int:post_id>',
         views.manage_post_comment,
         name='manage_post_comment'),
    path('request_comment/<int:comment_id>',
         views.request_comment,
         name='request_comment'),
    path('crud_comment/<int:comment_id>',
         views.crud_comment,
         name='crud_comment'),
    path('get_likes_from_post/<int:post_id>',
         views.get_likes_from_post,
         name='get_likes_from_post'),
    path('manage_post_like/<int:post_id>',
         views.manage_post_like,
         name='manage_post_like'),
    path('request_like/<int:like_id>', views.request_like,
         name='request_like'),
    path('crud_like/<int:like_id>', views.crud_like, name='crud_like'),
    path('send_token/<str:username>/<str:password>',
         views.send_token,
         name='send_token'),
    path('team15-posts/', views.view_t15_posts, name='t15-posts')
]
