...
urlpatterns = [
    ...
    path('<str:User_id>/posts/', views.user_post_view, name='view_user_posts'),
    path('<str:User_id>/page/', views.get_user_page, name='get_user_page'),
    path('<str:User_id>/posts/<int:post_id>/comments',
    ...
    path('<str:User_id>/followers/',
         views.follow_list,
         name='view_followers_REST'),
    path('<str:User_id>/following/',
    ...
    #path('<int:User_id>/get-followers/<int:Foreign_id>/',
         #views.get_follow,
         #name='get_followers'),
    path('<str:User_id>/followers/<str:Foreign_id>/',
         views.get_follow,
         name='crud_followers'),
    ...
    path('<str:author_id>/', views.ManageUserView.as_view(), name='user_crud'),
    path('<str:AUTHOR_ID>/posts/<int:POST_ID>',
